...
import com.sgahs.springboot.app.models.dao.IAhorroDao;
import com.sgahs.springboot.app.models.dao.ICatalogoAppInversion;
import com.sgahs.springboot.app.models.dao.IGastoDao;
import com.sgahs.springboot.app.models.dao.IGastoRecurrenteDao;
import com.sgahs.springboot.app.models.dao.IInversionDao;
import com.sgahs.springboot.app.models.dao.IPrestamoDao;
...
public class MovimientoServiceImpl implements IMovimientoService {
	...
	@Override
	@Transactional
	public void saveGastoRecurrente(GastoRecurrente gastoRecurrente) {
		gastoRecurrenteDao.save(gastoRecurrente);
	...
	public void saveInversion(Inversion inversion) {
		inversionDao.spuInversion(inversion.getFolio(), inversion.getMonto(), inversion.getDescripcion(), inversion.getFechaCreacion(),
				inversion.getCdEstatus(), inversion.getCdAppInversion(), inversion.getMontoRetirado());
	}
