...
import com.sgahs.springboot.app.models.dao.ICustomMovimientoRepository;
...
public class CustomMovimientoServiceImpl implements ICustomMovimientoService {
	...
	public Double obtenerGastoDisponible() {
		return customMovimientoRepository.obtenerGastoDisponible();
	}
	...
	public Double obtenerGastoMensual() {
		return customMovimientoRepository.obtenerGastoMensual();
	}
}
